...
public class MySQLDatabase implements Database {
    ...
    public MySQLDatabase(String hostname, String database, String username, String password, int port) throws ClassNotFoundException, SQLException {
        String driver = ThrowOut.get().getConfigOptions().databaseDriver;
        this.connectionUri = String.format("jdbc:%s://%s:%d/%s", getDriver(driver), hostname, port, database);
